# codegen-breaks-pod-install-on-old-arch

![Build](https://github.com/gladiuscode/codegen-breaks-pod-install-on-old-arch/workflows/Pre%20Merge%20Checks/badge.svg)
